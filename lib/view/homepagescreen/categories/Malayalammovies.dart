...
class Malayalammovies extends ConsumerWidget {
  const Malayalammovies({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final malayalammovies = ref.watch(malayalamprovider);
